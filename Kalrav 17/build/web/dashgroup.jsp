    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">UMANG'17 ADMIN PORTAL</a>
        </div>
...
<!--                  <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name" class="glyphicon glyphicon-search">-->
           <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search For Group Names , Roll Numbers , Events or Councils" title="Type in a name" class="glyphicon glyphicon-search">
